...
<div class="content-wrapper">
	...
	<div class="row">
		...
		<div class="col-xs-12 content-header" >
			...
			<h1 class="pull-left">Search Result For...</h1> </strong><?php echo $search; ?></h1>
		</div>
...
<h3 class="margin-none"><strong class="text-primary">Customers Search Result For </strong><?php echo $search; ?></h3>
