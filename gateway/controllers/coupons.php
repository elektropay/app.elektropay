...
class Coupons extends Controller {
	...
	public function index()
	{
		...
		$this->navigation->SidebarButton('<span class="btn btn-success"><i class="fa fa-plus"></i> Coupon</span>','coupons/add');
	...
	public function add()
	{
		...
		// sidebar
		$this->navigation->SidebarButton('<span class="btn btn-default"><i class="fa fa-dashboard"></i> Dashboard,/span>','dashboard');
		$this->navigation->SidebarButton('<span class="btn btn-info"><i class="fa fa-eye"></i> List View</span>','coupons');
	...
	public function edit ($id = 0)
	{
		...
		// sidebar
		$this->navigation->SidebarButton('<span class="btn btn-default"><i class="fa fa-eye"></i> List View</span>','coupons');
                $this->navigation->SidebarButton('<span class="btn btn-success"><i class="fa fa-plus"></i> Coupon</span>','coupons/add/');
